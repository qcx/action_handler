RSpec.describe ActionHandler::Sources::HTTP::V2 do
  describe :parametrize do
    ...
    context :queryStringParameters do
      ...
      context :multi do
        let(:event) { { 'rawQueryString' => 'level[]=1&level[]=2' } }
